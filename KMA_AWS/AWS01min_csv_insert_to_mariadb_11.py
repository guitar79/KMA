...
#log file
insert_log = open(drbase+'60min_import_result.log', 'a')
error_log = open(drbase+'60min_import_error.log', 'a')
...
for year in range(2012,2013):
    ...
    for ii in ['01','02','03','04','05','06','07','08','09','10','11','12']:
        ...
        for i in sorted(os.listdir(drbase+str(year)+"/")):
            ...
            with open(drbase+str(year)+ii+'.sql', 'w') as f:
                f.write(output)
